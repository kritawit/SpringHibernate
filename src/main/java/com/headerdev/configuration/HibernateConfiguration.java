...
@ComponentScan({"com.headerdev.configuration"})
...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactoryBean.setPackagesToScan(new String[] { "com.headerdev.model" });
	...
	private Properties hibernateProperties() {
		...
		properties.put("hibernate.formal_sql", environment.getRequiredProperty("hibernate.format_sql"));
